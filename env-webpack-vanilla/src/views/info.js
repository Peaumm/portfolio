import photo from '../assets/photo_langage/photo.jpg';
import css from '../assets/photo_langage/css.png';
import html from '../assets/photo_langage/html.png';
import js from '../assets/photo_langage/js.png';
import java from '../assets/photo_langage/java.svg';
import mysql from '../assets/photo_langage/mysql.svg';
import php from '../assets/photo_langage/php.png';
import python from '../assets/photo_langage/python.png';
    ...
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3">
        <div class="relative lg:row-span-2">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-4xl text-center font-medium tracking-tight text-gray-950 max-lg:text-center">Front-end</p>
            </div>
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
        ...
        <div class="relative max-lg:row-start-1">
          <img class="choose-img rounded-lg" src="${photo}"></img>
        </div>
        <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
          <div class="absolute inset-px rounded-lg bg-white"></div>
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
            <div class="px-8 pt-6 pb-10 sm:px-10 sm:pt-10">
        ...
        <div class="relative lg:row-span-2">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-4xl text-center font-medium tracking-tight text-gray-950 max-lg:text-center">Back-end</p>
            </div>
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
            ...
            <div class="px-8 mb-12 sm:px-10 sm:pb-0 sm:pt-10">
